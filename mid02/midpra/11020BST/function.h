...
class Array_BST : public BST{
    public:
        Array_BST(); //do this
        virtual ~Array_BST() {}
        virtual void insert(const int &) override; //root node is stored at index 1. do this
        virtual bool search(const int &) const override; //do this
...
class List_BST : public BST{
    public:
        ...
        virtual void insert(const int &) override; //do
        virtual bool search(const int &) const override; //do
        virtual void print() const override{
            int i;
            for(i = 1; i <= Height; i++){
